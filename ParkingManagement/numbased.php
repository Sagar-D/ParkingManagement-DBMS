...
$result = $db->query("Select * from history where vehicle_no like '".$num."'");

$res = $result->fetch_all(MYSQLI_ASSOC);

echo '<h1 style="padding :20px;color : white;font-weight : bold;font-size : 30px;text-align : center;" >'.$num.'</h1><br/>';
